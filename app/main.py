...
# importar routers
from app.routers import views, api_auth, api_salas
...
# Rutas de API REST
app.include_router(api_auth.router, prefix="/api/auth", tags=["Autenticación"])
app.include_router(api_salas.router, prefix="/api/salas", tags=["Salas"])
